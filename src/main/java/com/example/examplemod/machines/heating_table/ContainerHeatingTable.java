...
public class ContainerHeatingTable extends Container {
    private final TileEntityHeatingTable te;
    private int cookTime, energy;

    public ContainerHeatingTable(InventoryPlayer playerInv, TileEntityHeatingTable  te) {
        this.te = te;
