...
public class GuiCentrifuge extends GuiContainer {
    ...
    public GuiCentrifuge(InventoryPlayer playerInv, TileEntityCentrifuge tileEntity) {
        super(new ContainerCentrifuge(playerInv, tileEntity));
...
//        this.fontRenderer.drawString("Output", 120, 24, 0xBABABA);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        drawSlotBack(i + 35, j + 18);  //0: Кремний
        drawSlotBack(i + 65, j + 18);  //1: фоторезистек
        drawSlotBack(i + 125, j + 35); //2: Выход
        drawSlotBack(i + 50, j + 55);  //3: Угольный блок
